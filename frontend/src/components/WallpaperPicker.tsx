...
// // 이전에 작성했던 배경화면 데이터 파일에서 Wallpaper 타입을 가져옵니다.
// import {
//   WALLPAPER_SECTIONS,
//   WALLPAPERS,
//   type Wallpaper,
...
// // 1. WallpaperThumb 컴포넌트가 전달받을 props의 타입을 정의합니다.
...
// // 2. 컴포넌트에 Props 타입과 반환 타입(JSX.Element)을 명시합니다.
...
// // 3. 메인 컴포넌트의 반환 타입을 명시합니다.
// export function WallpaperPicker() {
//   const modal = useOverlayState();
//   const { wallpaperId, setWallpaperId } = useWallpaper();
//   const [, startTransition] = useTransition();

//   // 4. 선택 이벤트 핸들러의 매개변수 타입을 string으로, 반환 타입을 void로 명시합니다.
